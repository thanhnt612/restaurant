<?php 
    ...
    $foodGroup = array();
    foreach($dataFoodGroup as $key => $value){
        array_push($foodGroup,new FoodGroup($value[0],$value[1],$value[2],$value[3],$value[4]));
    }
?>
	...
	<div class="max-width d-flex flex-wrap align-items-center">
		<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
		  <ol class="breadcrumb mb-0">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Ẩm thực</li>
		  </ol>
		</nav>
	</div>
</div>
...
<div class="row justify-content-center">
	<div class="max-width d-flex flex-wrap justify-content-center align-items-center">
		<div class="col-12 filter-group d-flex justify-content-between align-items-center px-10 my-4">
			<h2 class="text-uppercase fw-bold mb-0">Ẩm thực</h2>
		        ...
		        <div class="card rounded-0">
		            <div class="card-heading position-relative">
		                ...
		                <?php 
		                    if($value->discount) {
		                ?>
		                    <div class="discount-label position-absolute px-10">
